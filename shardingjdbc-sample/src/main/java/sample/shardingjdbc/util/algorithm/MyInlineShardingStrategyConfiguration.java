...
@Getter
public final class MyInlineShardingStrategyConfiguration implements ShardingStrategyConfiguration {
    ...
    public ShardingStrategy build() {
        ...
        return new MyInlineShardingStrategy(shardingColumn, algorithmExpression);
    }
}
