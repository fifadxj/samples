...
package sample.shardingjdbc.util.algorithm;
 ...
 * @author zhangliang
 */
public final class MyInlineShardingStrategy implements ShardingStrategy {
    
    private final String shardingColumn;
    
    private final Closure<?> closure;
    
    public MyInlineShardingStrategy(final String shardingColumn, final String inlineExpression) {
    ...
    public Collection<String> doSharding(final Collection<String> availableTargetNames, final Collection<ShardingValue> shardingValues) {
        ...
        for (String availableTargetName : availableTargetNames) {
            //String suffix = availableTargetName.substring(availableTargetName.lastIndexOf("_") + 1, availableTargetName.length());
            for (String targetName : shardingResult) {
                if (availableTargetName.equals(targetName)) {
